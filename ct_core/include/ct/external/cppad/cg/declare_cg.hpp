...
template<class Base>
inline bool IdenticalPar(const cg::CG<Base>& x) noexcept (false);

template<class Base>
bool IdenticalZero(const cg::CG<Base>& x) noexcept (false);

template<class Base>
bool IdenticalOne(const cg::CG<Base>& x) noexcept (false);
